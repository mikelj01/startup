...
- [x] **Backend listens for WebSocket connection** - I did this in messages
- [x] **Frontend makes WebSocket connection** - I did this in messages
- [x] **Data sent over WebSocket connection** - I did this in messages
- [x] **WebSocket data displayed** - I did this in messages
- [x] **Application is fully functional** - I did this in messages
